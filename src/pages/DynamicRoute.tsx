...
const DynamicRoute: React.FC = () => {
    ...
    useEffect(() => {
        const loadRoute = () => {
            try {
                ...
                // 查找当前路径对应的路由配置
                const findRouteByPath = (routes: API.AdminRoute[], targetPath: string): API.AdminRoute | null => {
    ...
    const renderComponent = () => {
        ...
        console.log('start render component', routeConfig);
        ...
        switch (routeConfig.component) {
            ...
            // 这些会由 UmiJS 的静态路由处理
            default:
                return <div>Unsupported dynamic component: {routeConfig.component}</div>;
        }
    };
